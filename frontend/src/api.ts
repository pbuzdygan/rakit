...
export const Api = {
  ...
  semaphore: {
    profile: () => api('/api/semaphore/profile'),
    test: (payload: any) => api('/api/semaphore/profile/test', { method: 'POST', body: JSON.stringify(payload) }),
    create: (payload: any) => api('/api/semaphore/profile', { method: 'POST', body: JSON.stringify(payload) }),
  ...
  servers: {
    list: () => api('/api/servers'),
    get: (id: number) => api(`/api/servers/${id}`),
    create: (payload: any) => api('/api/servers', { method: 'POST', body: JSON.stringify(payload) }),
  ...
  serverGroups: {
    list: () => api('/api/server-groups'),
    create: (payload: any) => api('/api/server-groups', { method: 'POST', body: JSON.stringify(payload) }),
    update: (id: number, payload: any) => api(`/api/server-groups/${id}`, { method: 'PATCH', body: JSON.stringify(payload) }),
    remove: (id: number) => api(`/api/server-groups/${id}`, { method: 'DELETE' }),
  },
  serverActions: {
    list: (serverId?: number | null) => api(`/api/server-actions${serverId ? `?serverId=${serverId}` : ''}`),
    refresh: (id: number) => api(`/api/server-actions/${id}/refresh`, { method: 'POST', body: '{}' }),
  },
